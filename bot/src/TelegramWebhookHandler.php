...
class TelegramWebhookHandler
{
    ...
    private function sendServicesInfo($chatId, $messageId = null)
    {
        ...
        $message .= "Расслабляющий массаж и уходовые процедуры\n\n";        $message .= "🌿 <b>Травяной пар</b>\n";
        $message .= "Оздоровительный пар с целебными травами\n\n";
        $message .= "❄️ <b>Ледяная ванна</b>\n";
        $message .= "Охлаждение и закаливание после парной\n\n";
    ...
    private function sendContactInfo($chatId, $messageId = null)
    {
        ...
        $message .= "🏠 <b>Адрес:</b> 83/14 Moo 2, Wiset Rd, Rawai, Phuket 83100, Thailand\n";
